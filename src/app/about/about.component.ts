  ...
  ngOnInit() {
    ...
    if (window.location.pathname === '/about') {
      if (this.isAdmin) {
        ...
        document.getElementById('aboutBtnAdmin').setAttribute('style', 'border: 3px solid black;');
      } else {
        ...
        document.getElementById('aboutBtn').setAttribute('style', 'border: 3px solid black;');
      }
    }
  }
